   ...
   filter=()=>{
    ...
    //this.create()     
      ...
      for (let i = 0; i < len; i++) {
        ...
        var e = new Date(row.prev_timestamp)
        ...
        //console.log(row)
            var obj = {event:row.event,last_timestamp:date,curr_timestamp:date1,event:row.activity}
  ...
  render () {
    ...
    <View style={styles.drivingEvents}>
      ...
      <View style={{ flex:2, flexDirection: 'row'}}>
        <Text style={[styles.eventInfoText,{fontWeight:"bold"}]} >{item.last_timestamp}</Text>
